...
const seeds: SeedInput[] = [
  {
    ...
    ingredients: ["Vietnamese Coffee", "Sea Salt Cream", "Condensed Milk"],
    allergens: ["Dairy"],
  ...
  },
  {
    ...
    ingredients: ["Vietnamese Coffee", "Ube Extract", "Condensed Milk", "Ube Cream"],
    allergens: ["Dairy"],
  ...
  },
  {
    ...
    ingredients: ["Vietnamese Coffee", "Egg Cream", "Condensed Milk"],
  ...
  },
  {
    ...
    ingredients: ["Brown Sugar Syrup", "Fresh Milk"],
    allergens: ["Dairy"],
  ...
  },
  {
    ...
    ingredients: ["Premium Tea", "Brown Sugar Syrup", "Fresh Milk"],
    allergens: ["Dairy"],
    calories: "180-250 cal",
    low: 22,
    high: 30,
  },
  {
    ...
    ingredients: ["Brown Sugar Syrup", "Crème Brûlée Cream", "Fresh Milk", "Caramel Drizzle"],
    allergens: ["Dairy"],
  ...
  },
  {
    ...
    ingredients: ["Premium Black Tea", "Fresh Milk"],
    allergens: ["Dairy"],
  ...
  },
  {
    ...
    ingredients: ["Thai Tea Leaves", "Condensed Milk", "Spices"],
    allergens: ["Dairy"],
    calories: "200-280 cal",
    low: 22,
    high: 30,
  },
  {
    ...
    ingredients: ["Roasted Oolong Tea", "Fresh Milk"],
    allergens: ["Dairy"],
  ...
  },
  {
    ...
    ingredients: ["Premium Tea", "Ube Extract", "Fresh Milk", "Ube Cream"],
    allergens: ["Dairy"],
    calories: "220-300 cal",
    low: 26,
    high: 34,
  },
  {
    ...
    ingredients: ["Premium Tea", "Pistachio Syrup", "Fresh Milk", "Pistachio Cream"],
  ...
  },
  {
    ...
    ingredients: ["Premium Tea", "Horchata Base", "Cinnamon", "Fresh Milk"],
    allergens: ["Dairy"],
    calories: "200-280 cal",
    low: 24,
    high: 32,
  },
  {
    ...
    ingredients: ["Premium Tea", "Mango Puree", "Fresh Milk"],
    allergens: ["Dairy"],
    calories: "220-300 cal",
    low: 24,
    high: 32,
  },
  {
    ...
    ingredients: ["Premium Tea", "Honeydew Syrup", "Fresh Milk"],
    allergens: ["Dairy"],
    calories: "180-250 cal",
    low: 22,
    high: 30,
  },
  {
    ...
    ingredients: ["Premium Matcha Powder", "Fresh Milk"],
    allergens: ["Dairy"],
    calories: "160-230 cal",
    low: 26,
    high: 34,
  },
  {
    ...
    ingredients: ["Premium Matcha Powder", "Strawberry Puree", "Fresh Milk"],
    allergens: ["Dairy"],
    calories: "200-280 cal",
    low: 28,
    high: 36,
  },
  {
    ...
    ingredients: ["Premium Matcha Powder", "Mango Puree", "Fresh Milk"],
    allergens: ["Dairy"],
    calories: "220-300 cal",
    low: 28,
    high: 36,
  },
  {
    ...
    ingredients: ["Premium Matcha Powder", "Coconut Milk"],
    allergens: [],
    calories: "180-250 cal",
    low: 26,
    high: 34,
  },
  {
    ...
    ingredients: ["Jasmine Tea", "Sea Salt Cream"],
    allergens: ["Dairy"],
  ...
  },
  {
    ...
    ingredients: ["Oolong Tea", "Peach Syrup"],
    allergens: [],
  ...
  },
  {
    ...
    ingredients: ["Premium Tea", "Strawberry Puree", "Passionfruit Syrup"],
    allergens: [],
    calories: "140-200 cal",
    low: 24,
    high: 32,
  },
  {
    ...
    ingredients: ["Premium Tea", "Grapefruit Juice"],
    allergens: [],
  ...
  },
  {
    ...
    ingredients: ["Fresh Mango", "Sago Pearls", "Coconut Milk"],
    allergens: [],
  ...
  },
  {
    ...
    ingredients: ["Fresh Avocado", "Fresh Milk", "Condensed Milk"],
    allergens: ["Dairy"],
  ...
  },
  {
    ...
    ingredients: ["Ube Extract", "Fresh Milk", "Condensed Milk"],
    allergens: ["Dairy"],
